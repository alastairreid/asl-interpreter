...
val pp_expr : PP.formatter -> rt_expr -> unit
...
module type RuntimeLib = sig
  ...
  val cdiv_int : PP.formatter -> rt_expr -> rt_expr -> unit
  val crem_int : PP.formatter -> rt_expr -> rt_expr -> unit
  ...
  val cdiv_sintN : PP.formatter -> int -> rt_expr -> rt_expr -> unit
  val crem_sintN : PP.formatter -> int -> rt_expr -> rt_expr -> unit
  ...
  (* convert to/from C standard int *)
  val ffi_c2asl_cint           : PP.formatter -> rt_expr -> unit
  val ffi_asl2c_cint           : PP.formatter -> rt_expr -> unit
