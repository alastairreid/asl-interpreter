...
val set_range : formatter -> AST.set_range -> unit
val set_ranges : formatter -> AST.set_range list -> unit
...
val formals : formatter -> (Ident.t * AST.ty * AST.expr option) list -> unit
...
val kw_function : formatter -> unit
